...
<html>
	...
	<body>
		...
		%>
		<p>
			num1 + nun2 = ${num1+num2}<br>
			num1 - nun2 = ${num1-num2}<br>
			num1 * nun2 = ${num1*num2}<br>
			num1 / nun2 = ${num1/num2}<br><br>
			...
			num1 gt num2 = ${num1 gt num2}<br> <!-- great than -->
			num1 lt num2 = ${num1 lt num2}<br> <!-- less than -->
			num1 ge num2 = ${num1 ge num2}<br> <!-- great than equal -->
