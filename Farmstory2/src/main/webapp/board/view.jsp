...
<section id="board" class="view">
    ...
    <div>
        <a href="/Farmstory2/board/delete.do?cate=${cate}&type=${type}&no=${no}&pg=${pg}" class="btnDelete">삭제</a>
        <a href="/Farmstory2/board/modify.do?cate=${cate}&type=${type}&no=${no}&pg=${pg}" class="btnModify">수정</a>
